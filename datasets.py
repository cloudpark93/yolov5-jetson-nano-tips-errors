...
class LoadStreams:
    ...
    def __init__(self, sources='streams.txt', img_size=640, stride=32, auto=True):
        ...
        for i, s in enumerate(sources):  # index, source
            ...
            int(cap.set(cv2.CAP_PROP_FRAME_WIDTH, 800)) #newly added to control the size of the screen
            int(cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 600)) #newly added to control the size of the screen
